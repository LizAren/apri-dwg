...
// Il CAMPO è la sagoma piena su cui poggia il pittogramma: quadrato per
// antincendio ed emergenza, triangolo per il pericolo, cerchio per obbligo e
// divieto. È la geometria della segnaletica vera, e serve a due cose: si vede
// da lontano e si riconosce prima ancora di leggere il disegno dentro.
const CAMPI = {
  q: () => [0.02, 0.02, 0.98, 0.02, 0.98, 0.98, 0.02, 0.98, 0.02, 0.02],
  t: () => [0.5, 0.99, 0.99, 0.09, 0.01, 0.09, 0.5, 0.99],
  c: () => {
    const v = []
    for (let i = 0; i <= 48; i++) {
      const g = (i / 48) * Math.PI * 2
      v.push(0.5 + 0.48 * Math.cos(g), 0.5 + 0.48 * Math.sin(g))
    }
    return v
  },
}
...
export const SIMBOLI = [
  ...
  { id: 'via-fuga-dx', nome: 'Via di fuga →', cat: 'emergenza', campo: 'q', forme: [
    l(0.12, 0.5, 0.8, 0.5), p(0.62, 0.32, 0.84, 0.5, 0.62, 0.68) ] },
  { id: 'via-fuga-sx', nome: 'Via di fuga ←', cat: 'emergenza', campo: 'q', forme: [
    l(0.88, 0.5, 0.2, 0.5), p(0.38, 0.32, 0.16, 0.5, 0.38, 0.68) ] },
  { id: 'scala-emergenza', nome: 'Scala di emergenza', cat: 'emergenza', campo: 'q', forme: [
    p(0.14, 0.16, 0.34, 0.16, 0.34, 0.36, 0.54, 0.36, 0.54, 0.56, 0.74, 0.56, 0.74, 0.76, 0.9, 0.76),
    l(0.14, 0.16, 0.14, 0.86) ] },
  { id: 'punto-raccolta', nome: 'Punto di raccolta', cat: 'emergenza', campo: 'q', forme: [
  ...
  { id: 'primo-soccorso', nome: 'Kit primo soccorso', cat: 'emergenza', campo: 'q', forme: [
    rett(0.14, 0.24, 0.72, 0.52), rett(0.4, 0.76, 0.2, 0.06),
    l(0.5, 0.36, 0.5, 0.64), l(0.36, 0.5, 0.64, 0.5) ] },
  { id: 'dae', nome: 'Defibrillatore DAE', cat: 'emergenza', campo: 'q', forme: [
  ...
  // --- pericolo ------------------------------------------------------------
  { id: 'pericolo-generico', nome: 'Pericolo generico', cat: 'pericolo', campo: 't', forme: [
    l(0.5, 0.34, 0.5, 0.62), c(0.5, 0.25, 0.035) ] },
  { id: 'alta-tensione', nome: 'Alta tensione', cat: 'pericolo', campo: 't', forme: [
    p(0.56, 0.68, 0.42, 0.46, 0.52, 0.46, 0.42, 0.26) ] },
  { id: 'infiammabile', nome: 'Materiale infiammabile', cat: 'pericolo', campo: 't', forme: [
    fiamma(0.5, 0.24, 1.4) ] },
  { id: 'esplosivo', nome: 'Materiale esplosivo', cat: 'pericolo', campo: 't', forme: [
    c(0.5, 0.36, 0.1),
    l(0.5, 0.46, 0.5, 0.66), l(0.36, 0.4, 0.24, 0.5), l(0.64, 0.4, 0.76, 0.5) ] },
  { id: 'gas', nome: 'Gas', cat: 'pericolo', campo: 't', forme: [
    a(0.42, 0.36, 0.09, 180, 360),
    a(0.58, 0.46, 0.09, 0, 180), a(0.44, 0.56, 0.07, 180, 360) ] },
  { id: 'caduta', nome: 'Rischio di caduta', cat: 'pericolo', campo: 't', forme: [
    c(0.4, 0.6, 0.05),
    p(0.34, 0.54, 0.46, 0.46, 0.58, 0.5), p(0.4, 0.46, 0.36, 0.3), l(0.2, 0.24, 0.8, 0.24) ] },
  { id: 'carichi-sospesi', nome: 'Carichi sospesi', cat: 'pericolo', campo: 't', forme: [
    l(0.3, 0.66, 0.7, 0.66), l(0.5, 0.66, 0.5, 0.48),
    pc(0.4, 0.28, 0.6, 0.28, 0.6, 0.44, 0.4, 0.44) ] },

  // --- obbligo e divieto ---------------------------------------------------
  { id: 'divieto-fumo', nome: 'Vietato fumare', cat: 'obbligo', campo: 'c', forme: [
    l(0.2, 0.8, 0.8, 0.2), rett(0.24, 0.44, 0.4, 0.1), l(0.68, 0.56, 0.68, 0.68) ] },
  { id: 'divieto-accesso', nome: 'Vietato l’accesso', cat: 'obbligo', campo: 'c', forme: [
    rett(0.22, 0.44, 0.56, 0.12) ] },
  { id: 'divieto-spegnere-acqua', nome: 'Vietato spegnere con acqua', cat: 'obbligo', campo: 'c', forme: [
    l(0.2, 0.8, 0.8, 0.2), p(0.5, 0.28, 0.62, 0.46, 0.5, 0.6, 0.38, 0.46, 0.5, 0.28) ] },
  { id: 'obbligo-casco', nome: 'Casco obbligatorio', cat: 'obbligo', campo: 'c', forme: [
    a(0.5, 0.44, 0.24, 0, 180), l(0.2, 0.44, 0.8, 0.44) ] },
  { id: 'obbligo-guanti', nome: 'Guanti obbligatori', cat: 'obbligo', campo: 'c', forme: [
    rett(0.36, 0.26, 0.28, 0.3),
    l(0.4, 0.56, 0.4, 0.7), l(0.48, 0.56, 0.48, 0.74), l(0.56, 0.56, 0.56, 0.7), l(0.64, 0.5, 0.72, 0.6) ] },
  { id: 'obbligo-occhiali', nome: 'Occhiali obbligatori', cat: 'obbligo', campo: 'c', forme: [
    a(0.38, 0.5, 0.11, 0, 360), a(0.62, 0.5, 0.11, 0, 360), l(0.49, 0.5, 0.51, 0.5) ] },
  { id: 'obbligo-scarpe', nome: 'Calzature obbligatorie', cat: 'obbligo', campo: 'c', forme: [
    p(0.3, 0.36, 0.3, 0.56, 0.44, 0.6, 0.62, 0.5, 0.72, 0.44, 0.72, 0.36, 0.3, 0.36) ] },
...
/**
 * Le forme di un simbolo, in coordinate 0..1.
 *
 * 🔴 Restituisce OGGETTI, non liste di numeri: ogni forma dice se va riempita
 * e se va disegnata in chiaro. Serve perché un simbolo di sicurezza è fatto
 * così — una sagoma piena col pittogramma in negativo — ed è quello che lo
 * rende leggibile a tre metri invece che a trenta centimetri.
 */
export function formeSimbolo(id) {
  const s = PER_ID[id]
  if (!s) return []
  const fuori = []
  if (s.campo) fuori.push({ punti: CAMPI[s.campo](), pieno: true, chiaro: false })
  for (const f of s.forme) {
    const [tipo, ...v] = f
    let punti
    if (tipo === 'l') punti = [v[0], v[1], v[2], v[3]]
    else if (tipo === 'p') punti = v.slice()
    else if (tipo === 'pc') punti = [...v, v[0], v[1]]
    else if (tipo === 'c') punti = archi(v[0], v[1], v[2], 0, 360)
    else if (tipo === 'a') punti = archi(v[0], v[1], v[2], v[3], v[4])
    else continue
    // Sopra un campo pieno il pittogramma va in chiaro; senza campo prende il
    // colore del simbolo, e le forme marcate `pieno` si riempiono.
    fuori.push({ punti, pieno: !!f.pieno, chiaro: !!s.campo })
  }
  return fuori
}
